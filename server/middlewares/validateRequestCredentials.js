...
export const validateUserModification = (req, res, next) => {
  ...
  rule.contactMobile = req.body.contactMobile ? 'required|numeric' : '';
  return validateRequestCredentials(req, res, next, rule);
};

export const validateEmailOnRequestChangePassword = (req, res, next) => {
  const rule = {
    email: 'required|email',
  };
  return validateRequestCredentials(req, res, next, rule);
...
export const validateBucketListCreation = (req, res, next) => {
  const rule = {
...
export const validateBucketItemsCreation = (req, res, next) => {
  const rule = {
    name: 'required|string',
  };
  return validateRequestCredentials(req, res, next, rule);
